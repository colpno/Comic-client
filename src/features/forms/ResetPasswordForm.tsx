...
import { resetPasswordFormSchema, ResetPasswordFormValues } from './validationSchemas.ts';
...
function ResetPasswordForm({ onSubmit }: Props) {
  ...
  return (
    <div>
      ...
      <Form validationSchema={resetPasswordFormSchema} onSubmit={onSubmit} className="space-y-4">
